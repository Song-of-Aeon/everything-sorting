global.__horriFi = 
{
	...
	#region Shader Uniforms
		...
		uniEnable	: shader_get_uniform(z_vcr, "enable"),
		uniTime		: shader_get_uniform(z_vcr, "time"),
		uniSeed		: shader_get_uniform(z_vcr, "seed"),
		uniTexel	: shader_get_uniform(z_vcr, "texel"),
		uniVig		: shader_get_uniform(z_vcr, "vignette"),
		uniNstr		: shader_get_uniform(z_vcr, "noise_strength"),
		uniChab		: shader_get_uniform(z_vcr, "chab_intensity"),
		uniBloom	: shader_get_uniform(z_vcr, "bloom"),
		uniScanStr	: shader_get_uniform(z_vcr, "scan_strength"),
		uniVhs		: shader_get_uniform(z_vcr, "vhs_strength"),
		uniCurve	: shader_get_uniform(z_vcr, "curve"),
